...
Thank you for using and improving **react-native-nitro-google-signin**. These pages describe how we work together as a community.

| Guideline | Summary |
| --------- | ------- |
| [Contributing](/docs/community/contributing) | Set up the repo, open PRs, update docs and the agent skill |
| [Code of Conduct](/docs/community/code-of-conduct) | Expected behavior; how to report abuse |
| [Security policy](/docs/community/security) | Responsible disclosure for vulnerabilities |
| [Support](/docs/community/support) | Issue templates, docs, and where to ask questions |
